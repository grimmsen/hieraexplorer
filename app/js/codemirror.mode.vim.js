  ...
  var Vim = function() {
    ...
    * in the right place.
    ...
    function dialog(cm, template, shortText, onClose, options) {
      if (cm.openDialog) {
        cm.openDialog(template, onClose, { value: options.value,
    ...
    function makePrompt(prefix, desc) {
      ...
      raw = (prefix || "")+'<input class="vim-input" type="text">'
      return raw;
    }
    ...
    var exCommands = {
      ...
      writequit: function(cm) { exCommands.write(cm);exCommands.quit(); },
      quit: function() { window.history.back(); },
      write: function(cm) {
